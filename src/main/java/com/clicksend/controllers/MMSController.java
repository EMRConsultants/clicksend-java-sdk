...
public class MMSController extends BaseController {    
    ...
    private static MMSController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the MMSController class 
     */
    public static MMSController getInstance() {
    ...
    public String sendMMS(
        ...
        sendMMSAsync(mmsMessages, callback);
    ...
    public void sendMMSAsync(
        ...
        if (null == mmsMessages)
            throw new NullPointerException("The parameter \"mmsMessages\" is a required parameter and cannot be null.");
        ...
        final HttpRequest _request = getClientInstance().postBody(_queryUrl, _headers, APIHelper.serialize(mmsMessages),
    ...
    public String getPrice(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        getPriceAsync(mmsMessages, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void getPriceAsync(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/mms/price");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
