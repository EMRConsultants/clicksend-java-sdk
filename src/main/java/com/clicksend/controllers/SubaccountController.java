...
public class SubaccountController extends BaseController {    
     ...
     */
    public void getSubaccountsAsync(
...
>>>>>>> Stashed changes
    ...
    public String updateSubaccount(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        updateSubaccountAsync(subaccountId, subaccount, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void updateSubaccountAsync(
        ...
        if (null == subaccount)
            throw new NullPointerException("The parameter \"subaccount\" is a required parameter and cannot be null.");
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/subaccounts/{subaccount_id}");
...
>>>>>>> Stashed changes
        ...
        //prepare and invoke the API call request to fetch the response
        final HttpRequest _request = getClientInstance().putBody(_queryUrl, _headers, APIHelper.serialize(subaccount),
                                        Configuration.username, Configuration.key);
    ...
    public String getSubaccount(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        getSubaccountAsync(subaccountId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
...
>>>>>>> Stashed changes
    ...
    public String deleteSubaccount(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        deleteSubaccountAsync(subaccountId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
...
>>>>>>> Stashed changes
    ...
    public String regenerateApiKey(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        regenerateApiKeyAsync(subaccountId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void regenerateApiKeyAsync(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/subaccounts/{subaccount_id}/regen-api-key");
...
>>>>>>> Stashed changes
    ...
    public String createSubaccount(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createSubaccountAsync(subaccount, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
...
>>>>>>> Stashed changes
        ...
        //prepare and invoke the API call request to fetch the response
        final HttpRequest _request = getClientInstance().postBody(_queryUrl, _headers, APIHelper.serialize(subaccount),
                                        Configuration.username, Configuration.key);
