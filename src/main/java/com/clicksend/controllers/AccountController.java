...
>>>>>>> Stashed changes
    ...
    public String createAccount(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        createAccountAsync(account, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void createAccountAsync(
        ...
        if (null == account)
            throw new NullPointerException("The parameter \"account\" is a required parameter and cannot be null.");
...
>>>>>>> Stashed changes
    ...
    public String accountVerifySend(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        accountVerifySendAsync(accountVerify, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void accountVerifySendAsync(
        ...
        //validating required parameters
        if (null == accountVerify)
            throw new NullPointerException("The parameter \"accountVerify\" is a required parameter and cannot be null.");
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/account-verify/send");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
...
>>>>>>> Stashed changes
        ...
        //prepare and invoke the API call request to fetch the response
        final HttpRequest _request = getClientInstance().putBody(_queryUrl, _headers, APIHelper.serialize(accountVerify),
                                        Configuration.username, Configuration.key);
    ...
    public String accountVerify(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        accountVerifyAsync(activationToken, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void accountVerifyAsync(
                final int activationToken,
                final APICallBack<String> callBack
    ) {
        //the base uri for api requests
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/account-verify/verify/{activation_token}");
...
>>>>>>> Stashed changes
    ...
    public String forgotUsername(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        forgotUsernameAsync(email, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void forgotUsernameAsync(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/forgot-username");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
...
>>>>>>> Stashed changes
        ...
        //prepare and invoke the API call request to fetch the response
        final HttpRequest _request = getClientInstance().putBody(_queryUrl, _headers, email);
    ...
    public String forgotPassword(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        forgotPasswordAsync(username, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void forgotPasswordAsync(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/forgot-password");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
...
>>>>>>> Stashed changes
        ...
        //prepare and invoke the API call request to fetch the response
        final HttpRequest _request = getClientInstance().putBody(_queryUrl, _headers, username,
                                        Configuration.username, Configuration.key);
    ...
    public String verifyForgotPassword(
        ...
        APICallBackCatcher<String> callback = new APICallBackCatcher<String>();
        verifyForgotPasswordAsync(verifyPassword, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void verifyForgotPasswordAsync(
        ...
        //validating required parameters
        if (null == verifyPassword)
            throw new NullPointerException("The parameter \"verifyPassword\" is a required parameter and cannot be null.");
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/forgot-password/verify");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
...
>>>>>>> Stashed changes
        ...
        //prepare and invoke the API call request to fetch the response
        final HttpRequest _request = getClientInstance().putBody(_queryUrl, _headers, APIHelper.serialize(verifyPassword),
                                        Configuration.username, Configuration.key);
